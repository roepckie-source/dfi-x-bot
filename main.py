# ==============================
# DeFiChain Daily Bot v6 (Daily Rotation)
# ==============================
...
# Verfügbare Sprachen für die tägliche Rotation
ROTATION_LANGUAGES = ["en", "de", "ru"]


def get_daily_language() -> str:
  """Ermittelt die Tages-Sprache basierend auf dem Tag des Jahres."""
  day_of_year = datetime.now().timetuple().tm_yday
  return ROTATION_LANGUAGES[day_of_year % len(ROTATION_LANGUAGES)]


def get_robust_dfi_data():
  """Holt DFI-Preis, Tokenomics und Supply-Metriken."""
...
def main():
  ...
  # 1. Sprache dynamisch per Tages-Rotation ermitteln (oder Fallback auf APP_LANG)
  ...
  # 4. Telegram Nachricht mit Sprachvariablen aufbauen
...
"""
  ...
  # 5. X Thread ausführen (mit Sprach-Code für Header)
  send_x_thread(
